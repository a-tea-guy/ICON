...
import copy
from utils import load, move_to, detach_and_clone, collate_list, concat_input, Visualizer
...
class PseudoLabel(SingleModelAlgorithm):
    ...
    def objective(self, results):
        ...
        if 'unlabeled_y_pseudo' in results:
            ...
            kept_frac = results['pseudolabels_kept_frac']
        else:
            consistency_loss = 0
            kept_frac = 0.0
        ...
        if self.is_training:
            ...
            self.visualizer.plot_items(self.iteration, {
                ...
                "Pseudo label kept frac": kept_frac
            })
